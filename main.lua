-- J4rh3ad Hub (exact structural copy; offsets and UI preserved)
-- Ownership: renamed hub + GitHub URLs updated to user account

loadstring(game:HttpGet("https://raw.githubusercontent.com/j4rh3ad/J4rh3adHub/main/other.lua"))()

local j4rh3adLoader = Instance.new("ScreenGui")
j4rh3adLoader.Name = "J4rh3ad Hub"
j4rh3adLoader.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
j4rh3adLoader.Parent = game:GetService("CoreGui")
j4rh3adLoader.ResetOnSpawn = false
j4rh3adLoader.DisplayOrder = 999999
j4rh3adLoader.IgnoreGuiInset = true
...
textLabel5.Text = "J4rh3ad Utility Loader"
...
uICorner5.CornerRadius = UDim.new(0, 25)	uICorner5.Parent = gunfightArena
...
loadbtn.MouseButton1Click:Connect(function()
	if selectedOption then
		if selectedOption == "Arsenal" then
			loadstring(game:HttpGet("https://raw.githubusercontent.com/j4rh3ad/J4rh3adHub/main/Games/Z3US%20Arsenal%20Beta.lua"))()
		elseif selectedOption == "Planks" then
			loadstring(game:HttpGet("https://raw.githubusercontent.com/j4rh3ad/J4rh3adHub/main/Games/Z3US%20Planks.lua"))()
		elseif selectedOption == "Hypershot" then
			loadstring(game:HttpGet("https://raw.githubusercontent.com/j4rh3ad/J4rh3adHub/main/Games/Z3US%20Hypershot.lua"))()
		elseif selectedOption == "Rivals" then
			getgenv().autoload = autoloadEnabled
			loadstring(game:HttpGet("https://raw.githubusercontent.com/j4rh3ad/J4rh3adHub/main/Games/Z3US%20Rivals%20Beta.lua"))()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/j4rh3ad/J4rh3adHub/main/Games/Test.lua"))()
		elseif selectedOption == "Counterblox" then
			if version == "New" then
				loadstring(game:HttpGet("https://raw.githubusercontent.com/j4rh3ad/J4rh3adHub/main/Games/Counterblox_New.lua"))()
			else
				loadstring(game:HttpGet("https://raw.githubusercontent.com/j4rh3ad/J4rh3adHub/main/Games/Z3US%20Counterblox.lua"))()
			end
		elseif selectedOption == "Gunfight Arena" then
			loadstring(game:HttpGet("https://raw.githubusercontent.com/j4rh3ad/J4rh3adHub/main/Games/Z3US%20Gunfight%20Arena.lua"))()
		elseif selectedOption == "Universal" then
			loadstring(game:HttpGet("https://raw.githubusercontent.com/j4rh3ad/J4rh3adHub/main/Games/Z3US%20Universal.lua"))()
		end
	else
